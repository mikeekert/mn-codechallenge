...
(function (SelectState) {
    ...
    var SelectStateDirective = (function () {
        function SelectStateDirective() {
            this.template = '<select  ng-model="cont.user.src.state" ng-require class="form-control"><option disabled selected value> -- select an option -- </option><option ng-repeat="state in states" value="{{state.code}}">{{state.name}}</option></select>';
            this.scope = {};
            var states = [
